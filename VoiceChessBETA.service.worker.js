...
/** @type {string} */
const CACHE_VERSION = '1770912667|14355800278';
/** @type {string} */
const CACHE_PREFIX = 'Wizard Chess Voi-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'VoiceChessBETA.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["VoiceChessBETA.html","VoiceChessBETA.js","VoiceChessBETA.offline.html","VoiceChessBETA.icon.png","VoiceChessBETA.apple-touch-icon.png","VoiceChessBETA.audio.worklet.js","VoiceChessBETA.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["VoiceChessBETA.wasm","VoiceChessBETA.pck"];
