...
/** @type {string} */
const CACHE_VERSION = '1772633030|354924465';
/** @type {string} */
const CACHE_PREFIX = 'Wizard Chess Voi-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'VoiceChessBETAV2March26.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["VoiceChessBETAV2March26.html","VoiceChessBETAV2March26.js","VoiceChessBETAV2March26.offline.html","VoiceChessBETAV2March26.icon.png","VoiceChessBETAV2March26.apple-touch-icon.png","VoiceChessBETAV2March26.audio.worklet.js","VoiceChessBETAV2March26.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["VoiceChessBETAV2March26.wasm","VoiceChessBETAV2March26.pck"];
